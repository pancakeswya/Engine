...
void SingleTimeCommander::Begin() {
...
void BufferCommander::CopyBuffer(const Buffer& src) {
...
void ImageCommander::GenerateMipmaps() {
...
void ImageCommander::TransitImageLayout(VkImageLayout old_layout, VkImageLayout new_layout) {
  VkImageMemoryBarrier barrier = {};
  barrier.sType = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER;
...
void ImageCommander::CopyBuffer(const Buffer& src) {
